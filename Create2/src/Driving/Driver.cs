    ...
    public class Driver
    {
        ...
        private short GetProperSpeed(short speed)
        {
            if (Math.Abs(speed) > MaxSpeed)
            {
                ...
                this.logger.LogWarning($"Speed is out of range. It will be set at closest valid value. (Original Speed: {originalValue}, New Speed: {speed}");
            }
        ...
        private short GetProperRadius(short radius)
        {
            if (Math.Abs(radius) > MaxRadius)
            {
                ...
                this.logger.LogWarning($"Radius is out of range. It will be set at closest valid value. (Original radius: {originalValue}, New radius: {radius}");
            }
        ...
        private short GetProperPwm(short pwm)
        {
            if (Math.Abs(pwm) > MaxPwm)
            {
                ...
                this.logger.LogWarning($"PWM is out of range. It will be set at closest valid value. (Original pwm: {originalValue}, New pwm: {pwm}");
            }
