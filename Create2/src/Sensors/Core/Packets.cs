namespace Create2.Sensors.Core
{
  public static class Packets
  {
    ...
    public static readonly SensorPacket LightBumpCenterLeftSignal =
      new SensorPacket(Sensor.LightBumpCenterLeftSignal, 2);

    public static readonly SensorPacket LightBumpCenterRightSignal =
      new SensorPacket(Sensor.LightBumpCenterRightSignal, 2);

    public static readonly SensorPacket LightBumpFrontRightSignal =
      new SensorPacket(Sensor.LightBumpFrontRightSignal, 2);
